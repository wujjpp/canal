...
public class MappingConfigLoader {
    ...
    public static Map<String, MappingConfig> load(Properties envProperties) {
        logger.info("## Start loading tcp mapping config ... ");

        Map<String, MappingConfig> result = new LinkedHashMap<>();

        Map<String, String> configContentMap = MappingConfigsLoader.loadConfigs("tcp");
        ...
        logger.info("## tcp mapping config loaded");
        return result;
    }
}
